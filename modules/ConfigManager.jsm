...
const DEFAULT_WEBAPPS = [{
  'id': 'pegase',
  'name': 'P\u00E9gase',
  'href': 'https://qualification.sondage.mce.interieur.rie.gouv.fr/',
  'icon': 'https://qualification.sondage.mce.interieur.rie.gouv.fr/favicon.ico',
  'show': true,
  'login': true,
  'autologin': true,
  'login_page': 'https://qualification.sondage.mce.interieur.rie.gouv.fr/?_p=login',
  'external_login_page': 'https://qualification.sondage.mce.interieur.rie.gouv.fr/?_p=external_login',
  'login_params': 'username=%%username%%&password=%%password%%&timezone=%%timezone%%',
  'request_type': 'POST',
  'url': {
    'createPoll': 'https://qualification.sondage.mce.interieur.rie.gouv.fr/?_p=edit&_a=new',
  },
}, {
  'id': 'export_agenda',
  'name': 'Export agenda',
  'href': 'https://qualification.webmail.mce.interieur.rie.gouv.fr/?_task=calendar',
  'show': false,
  'login': false,
}, {
  'id': 'export_contacts',
  'name': 'Export contacts',
  'href': 'https://qualification.webmail.mce.interieur.rie.gouv.fr/?_task=addressbook',
  'show': false,
  'login': false,
}, {
  'id': 'roundcube',
  'name': 'Mon compte',
  'href': 'https://qualification.webmail.mce.interieur.rie.gouv.fr/?_task=settings',
  'icon': 'https://qualification.webmail.mce.interieur.rie.gouv.fr/skins/mel_larry/images/favicon.ico',
  'show': true,
  'login': true,
  'autologin': true,
  'login_page': 'https://qualification.webmail.mce.interieur.rie.gouv.fr/?_task=login&_courrielleur=1',
  'login_params': '_user=%%username%%&_pass=%%password%%&_task=login&_action=login&_keeplogin=1&_timezone=%%timezone%%',
  'request_type': 'POST',
  'default_url': 'https://qualification.webmail.mce.interieur.rie.gouv.fr/?_task=settings&_action=plugin.mel_moncompte&_courrielleur=1',
  'url': {
    'createFilter': 'https://qualification.webmail.mce.interieur.rie.gouv.fr/?_task=settings&_action=plugin.managesieve&_courrielleur=1',
    'shareCalendar': 'https://qualification.webmail.mce.interieur.rie.gouv.fr/?_task=settings&_action=plugin.mel_resources_agendas&_courrielleur=1',
    'shareTaskslist': 'https://qualification.webmail.mce.interieur.rie.gouv.fr/?_task=settings&_action=plugin.mel_resources_tasks&_courrielleur=1',
    'shareAddressbook': 'https://qualification.webmail.mce.interieur.rie.gouv.fr/?_task=settings&_action=plugin.mel_resources_contacts&_courrielleur=1',
  },
}];
