...
const DEFAULT_WEBAPPS = [{
  ...
  'icon': 'https://pegase.din.developpement-durable.gouv.fr/favicon.ico',
  'show': true,
  'login': true,
  'autologin': true,
  'login_page': 'https://pegase.din.developpement-durable.gouv.fr/?_p=login',
  'external_login_page': 'https://pegase.din.developpement-durable.gouv.fr/?_p=external_login',
  'login_params': 'username=%%username%%&password=%%password%%&timezone=%%timezone%%',
  'request_type': 'POST',
  'url': {
    'createPoll': 'https://pegase.din.developpement-durable.gouv.fr/?_p=edit&_a=new',
  },
}, {
  'id': 'export_agenda',
  'name': 'Export agenda',
  'href': 'https://mel.din.developpement-durable.gouv.fr/?_task=calendar',
  'show': false,
  'login': false,
}, {
  'id': 'export_contacts',
  'name': 'Export contacts',
  'href': 'https://mel.din.developpement-durable.gouv.fr/?_task=addressbook',
  'show': false,
  'login': false,
}, {
  'id': 'roundcube',
  'name': 'Mon compte',
  'href': 'https://mel.din.developpement-durable.gouv.fr/?_task=settings',
  'icon': 'https://mel.din.developpement-durable.gouv.fr/skins/mel_larry/images/favicon.ico',
  'show': true,
  'login': true,
  'autologin': true,
  'login_page': 'https://mel.din.developpement-durable.gouv.fr/?_task=login&_courrielleur=1',
  'login_params': '_user=%%username%%&_pass=%%password%%&_task=login&_action=login&_keeplogin=1',
  'request_type': 'POST',
  'default_url': 'https://mel.din.developpement-durable.gouv.fr/?_task=settings&_action=plugin.mel_moncompte&_courrielleur=1',
  'url': {
    'createFilter': 'https://mel.din.developpement-durable.gouv.fr/?_task=settings&_action=plugin.managesieve&_courrielleur=1',
    'shareCalendar': 'https://mel.din.developpement-durable.gouv.fr/?_task=settings&_action=plugin.mel_resources_agendas&_courrielleur=1',
    'shareTaskslist': 'https://mel.din.developpement-durable.gouv.fr/?_task=settings&_action=plugin.mel_resources_tasks&_courrielleur=1',
    'shareAddressbook': 'https://mel.din.developpement-durable.gouv.fr/?_task=settings&_action=plugin.mel_resources_contacts&_courrielleur=1',
  },
}];
