...
const DEFAULT_WEBAPPS = [{
  'id': 'pegase',
  'name': 'P\u00E9gase',
  'href': 'https://dev.sondage.mce.interieur.rie.gouv.fr/',
  'icon': 'https://dev.sondage.mce.interieur.rie.gouv.fr/favicon.ico',
  'show': true,
  'login': true,
  'autologin': true,
  'login_page': 'https://dev.sondage.mce.interieur.rie.gouv.fr/?_p=login',
  'external_login_page': 'https://dev.sondage.mce.interieur.rie.gouv.fr/?_p=external_login',
  'login_params': 'username=%%username%%&password=%%password%%&timezone=%%timezone%%',
  'request_type': 'POST',
  'url': {
    'createPoll': 'https://dev.sondage.mce.interieur.rie.gouv.fr/?_p=edit&_a=new',
  },
}, {
  'id': 'export_agenda',
  'name': 'Export agenda',
  'href': 'https://dev.webmail.mce.interieur.rie.gouv.fr/?_task=calendar',
  'show': false,
  'login': false,
}, {
  'id': 'export_contacts',
  'name': 'Export contacts',
  'href': 'https://dev.webmail.mce.interieur.rie.gouv.fr/?_task=addressbook',
  'show': false,
  'login': false,
}, {
  'id': 'roundcube',
  'name': 'Mon compte',
  'href': 'https://dev.webmail.mce.interieur.rie.gouv.fr/?_task=settings',
  'icon': 'https://dev.webmail.mce.interieur.rie.gouv.fr/skins/mel_larry/images/favicon.ico',
  'show': true,
  'login': true,
  'autologin': true,
  'login_page': 'https://dev.webmail.mce.interieur.rie.gouv.fr/?_task=login&_courrielleur=1',
  'login_params': '_user=%%username%%&_pass=%%password%%&_task=login&_action=login&_keeplogin=1&_timezone=%%timezone%%',
  'request_type': 'POST',
  'default_url': 'https://dev.webmail.mce.interieur.rie.gouv.fr/?_task=settings&_action=plugin.mel_moncompte&_courrielleur=1',
  'url': {
    'createFilter': 'https://dev.webmail.mce.interieur.rie.gouv.fr/?_task=settings&_action=plugin.managesieve&_courrielleur=1',
    'shareCalendar': 'https://dev.webmail.mce.interieur.rie.gouv.fr/?_task=settings&_action=plugin.mel_resources_agendas&_courrielleur=1',
    'shareTaskslist': 'https://dev.webmail.mce.interieur.rie.gouv.fr/?_task=settings&_action=plugin.mel_resources_tasks&_courrielleur=1',
    'shareAddressbook': 'https://dev.webmail.mce.interieur.rie.gouv.fr/?_task=settings&_action=plugin.mel_resources_contacts&_courrielleur=1',
  },
}];
